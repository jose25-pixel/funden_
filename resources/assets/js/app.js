...
Vue.component('ingresousuario', require('./components/IngresoUsuario.vue'));
Vue.component('venta', require('./components/Venta.vue'));
Vue.component('ventausuario', require('./components/VentaUsuario.vue'));
...
Vue.component('consultamedicamento', require('./components/ConsultaMedicamento.vue'));
