        ...
        <div class="modal-content">
          ...
          <div class="modal-body ">
            <form
              ...
              <div class="form-group row">
                <label class="col-md-3 form-control-label" for="text-input">
                  <spam style="color: red">Nombre (*)</spam>
                </label>
                <div class="col-md-9">
                  <input
                    type="text"
              ...
              <div class="form-group row">
                <label class="col-md-3 form-control-label" for="text-input">
                  <spam style="color: red">Concentración(*)</spam>
                </label>
                <div class="col-md-9">
                  <input
                    type="text"
              ...
              <div class="form-group row">
                <label class="col-md-3 form-control-label" for="text-input">
                  <spam style="color: red">Gramaje(*)</spam>
                </label>
                <div class="col-md-9">
              ...
              <div class="form-group row">
                <label class="col-md-3 form-control-label" for="text-input">
                  <spam style="color: red">Tipo Administración(*)</spam>
                </label>
                <div class="col-md-9">
              ...
              <div class="form-group row">
                <label class="col-md-3 form-control-label" for="text-input">
                  <spam style="color: red">Presentación(*)</spam>
                </label>
                <div class="col-md-9">
                  <input
                    type="text"
...
export default {
  ...
  methods: {
    ...
    listarArticulofeha(id, desde, hasta) {
      ...
      window.open(
        "/articulo/pdf/" + id, "_blank" + "&desde=" + desde + "&hasta=" + hasta );
    ...
    validarArticulo() {
      ...
      if (!this.presentacion)
        this.errorMostrarMsjArticulo.push(
          "El campo presentacion no puede quedar vacio."
        );
      if (!this.administracion)
        this.errorMostrarMsjArticulo.push(
          "El campo de via de administracion no puede quedar vacio."
        );
      if (!this.concentracion)
        this.errorMostrarMsjArticulo.push(
          "El campo concentracion no puede quedar vacio"
        );
    ...
    abrirModalfecha(modelo, accion, data = []) {
      switch (modelo) {
        case "articulo": {
          switch (accion) {
            case "fecha": {
