    ...
    <div class="container-fluid">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <!--tabla para mostrar el contenido de-->
          <table
            ...
            <tbody>
              <tr v-for="users in arrayUsuario" :key="users.id">
                <td>
                  <button
                    type="button"
                    @click="abrirModal('users', 'actualizar', users)"
                  ...
                  <template v-if="users.condicion">
                    <button
                      ...
                      @click="desactivarUsuario(users.id)"
                    >
      ...
      <div class="modal-dialog modal-primary modal-lg" role="document">
        <div class="modal-content">
            ...
            >
              <div class="form-group row">
                <div class="form-group col-md-6">
                  <label class="col-md-9 form-control-label" for="text-input"
                    >Nombre
                    <span style="color: red" v-show="nombre == 0"
                      >(*Ingrese)
                    </span>
                  </label>
                  <div>
                ...
                <div class="form-group col-md-6">
                  <label class="col-md-9 form-control-label" for="email-input"
                    >Email
                    <span style="color: red" v-show="email == 0"
                      >(*Ingrese)
                    </span>
                  </label>
                  <div>
              ...
              <div class="form-group row">
                <div class="form-group col-md-6">
                  <label class="col-md-9 form-control-label" for="email-input"
                    >Teléfono
                    <span style="color: red" v-show="telefono == 0"
                      >(*Ingrese)
                    </span>
                  </label>
                  <div>
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                  <label class="col-md-9 form-control-label" for="email-input"
                    >Rol
                    <span style="color: red" v-show="idrol == 0"
                      >(*Ingrese)
                    </span>
                  </label>
                  <div>
                ...
                <div class="form-group col-md-4">
                  <label class="col-md-9 form-control-label" for="email-input"
                    >Usuario
                    <span style="color: red" v-show="usuario == 0"
                      >(*Ingrese)
                    </span>
                  </label>
                  <div>
                ...
                <div class="form-group col-md-4">
                  <label class="col-md-9 form-control-label" for="email-input"
                    >Password
                    <span style="color: red" v-show="password == 0"
                      >(*Ingrese)
                    </span>
                  </label>
                  <div>
          ...
          <div class="modal-footer">
            <p>
              Si seleciona tipo de documento, es obligatorio que ingrese el
              Número de Documento.
            </p>
  ...
  methods: {
    ...
    validarUsuario() {
      ...
      if (this.nombre == "" || this.nombre == null) {
        ...
        this.errorMostrarMsjUsuario.push(
          "El nombre de la persona  no debe contener números"
        );
      } else if (!/^[A-Z]/.test(this.nombre)) {
        this.errorMostrarMsjUsuario.push(
          "El nombre de la persona debe iniciar con una letra mayúscula"
        );
      ...
      /*Validación de la contraseña*/
        this.errorMostrarMsjUsuario.push(
          "El password del usuario no puede estar vacío"
        );
      } else if (this.password.length <= 7) {
        this.errorMostrarMsjUsuario.push(
          "La contraseña debe de contener mas de 7 caracteres"
        );
      }
      ...
      if (!this.tipo_documento == "") {
        if (this.num_documento == "") {
          this.errorMostrarMsjUsuario.push(
            "El número de documento del usuario no puede estar vacío."
          );
        ...
        /*else if(!/^[0-9]+$/.test(this.num_documento)){
          ...
          this.errorMostrarMsjUsuario.push(
            "El número de documento del usuario no es valido, debe ser mas de 7 caracteres."
          );
        }
