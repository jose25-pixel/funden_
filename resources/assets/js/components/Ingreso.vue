                                ...
                                <div class="input-group">
                                    ...
                                    >
                                        <option value="tipo_comprobante"
                                            >Tipo Comprobante</option
                                        >
                                        <option value="num_comprobante"
                                            >Número Comprobante</option
                                        >
                            ...
                            >
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td
                                            v-text="ingreso.tipo_comprobante"
                                        ></td>
                                        <td
                                            v-text="ingreso.serie_comprobante"
                                        ></td>
                                        <td
                                            v-text="ingreso.num_comprobante"
                                        ></td>
                ...
                <template v-else-if="listado == 0">
                    <div class="card-body">
                        ...
                        <div class="form-group row border">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Cantidad pastillas </label>
                                    <input
                                        type="number"
                                        value="0"
                                        class="form-control"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Cantidad Blister </label>
                                    <input
                                        type="number"
                                        value="0"
                                        class="form-control"
                                        v-model="cantidad_blister"
                                    />
                                </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            >
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td
                                            v-text="
                                                inventario.concentracion +
                                                    inventario.nombre_gramaje
                                            "
                                        ></td>
                                        <td
                                            v-text="inventario.nombre_categoria"
                                        ></td>
                                        <td
                                            v-text="inventario.administracion"
                                        ></td>
                                        <td
                                            v-text="inventario.presentacion"
                                        ></td>
                                        <td
                                            v-text="inventario.cantidad_tableta"
                                        ></td>
                                        <td
                                            v-text="inventario.cantidad_blister"
                                        ></td>
...
export default {
    ...
    methods: {
        ...
        buscarArticulo() {
            let me = this;
            var url =
                "/inventario/buscarArticuloInventario?filtro=" + me.nombre;
