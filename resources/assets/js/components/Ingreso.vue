      ...
      <div class="card">
        ...
        <template v-if="listado == 1">
          <div class="card-body">
            ...
            <nav>
              <ul class="pagination">
                <li class="page-item cafe" v-if="pagination.current_page > 1">
                ...
                <li class="page-item cafe" v-for="page in pagesNumber" :key="page"
                  :class="[page == isActived ? 'active' : '']">
                  <a class="page-link" href="#" @click.prevent="cambiarPagina(page, buscar, criterio)"
                    v-text="page"></a>
                </li>
                <li class="page-item cafe"   v-if="pagination.current_page < pagination.last_page">
                  <a class="page-link cafe" href="#" @click.prevent="
                    cambiarPagina(
                      pagination.current_page + 1,
                      buscar,
                      criterio
        ...
        <template v-else-if="listado == 0">
          <div class="card-body">
            <div class="form-group row border">
              <div class="col-md-8">
                <div class="form-group">
                  <label for="">Proveedor<spam style="color: red">(*Ingrese)</spam></label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label>Serie Comprobante<spam style="color: red">(*Ingrese)</spam></label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label>Fecha_Compra<spam style="color: red">(*Seleccione)</spam></label>
            ...
            <div class="form-group row border">
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div class="form-inline">
                   <input type="text"  class="form-control" v-model="nombre" @keyup.enter="buscarArticulo()"
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <label>Cantidad pastillas<spam style="color: red" v-show="cantidad == 0">(*)</spam>
                  </label>
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <label>Cantidad Blister<spam style="color: red" v-show="cantidad_blister == 0">(*)</spam>
                  </label>
                ...
                <table class="table table-bordered table-striped table-sm">
                  ...
                  <tbody v-if="arrayDetalle.length">
                    <tr v-for="(detalle, index) in arrayDetalle" :key="detalle.id">
                      ...
                      <td>
                        <input type="number" v-model="detalle.precio" value="5" class="form-control" />
                      </td>
                      <td>
                        <input type="number" v-model="detalle.cantidad" value="5" class="form-control" />
                      </td>
                      <td>
                        <input type="number" v-model="detalle.cantidad_blister" value="5" class="form-control" />
                      </td>
                      <td>
                        <input type="date" v-model="detalle.fecha_vencimiento" class="form-control" />
                      </td>
                      <td>
                        <input type="number" v-model="detalle.lote" value="5" class="form-control" />
                      </td>
              ...
              <div class="col-md-6">
                <div class="input-group">
                  ...
                  <input type="text" v-model="buscarA" @keyup.enter="listarArticuloinventario(buscarA, criterioA)"
                    class="form-control" placeholder="Texto a buscar" />
                  <button type="submit" class="btn btn-primary" @click="listarArticuloinventario(buscarA, criterioA)">
                    <i class="fa fa-search"></i> Buscar
                  </button>
                </div>
              </div>
