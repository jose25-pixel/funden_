                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" v-model="buscar" @keyup.enter="listargramaje(1, buscar, criterio)"
                                    class="form-control" placeholder="Texto a buscar">
                                <button type="submit" class="btn btn-cafe" @click="listargramaje(1, buscar, criterio)"><i
                    ...
                    <table class="table table-responsive table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            <tr v-for="gramaje in arraygramaje" :key="gramaje.id">
                                <td>
                                    <button type="button" @click="abrirModal('gramaje', 'actualizar', gramaje)"
                                        class="btn btn-warning btn-sm">
                                        <i class="icon-pencil"></i>
                                    </button> &nbsp;
                                    <template v-if="gramaje.condicion">
                                        <button type="button" class="btn btn-danger btn-sm"
                                            @click="desactivargramaje(gramaje.id)">
                                            <i class="icon-trash"></i>
                                        </button>
                                    </template>
                                    <template v-else>
                                        <button type="button" class="btn btn-info btn-sm"
                                            @click="activargramaje(gramaje.id)">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" v-model="gramaje" class="form-control"
                                        placeholder="Ingrese la medida de un gramaje">
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion == 1" class="btn btn-cafe"
                            @click="registrargramaje()">Guardar</button>
                        <button type="button" v-if="tipoAccion == 2" class="btn btn-cafe"
                            @click="actualizargramaje()">Actualizar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
